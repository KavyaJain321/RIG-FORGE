...
//
// Authenticated proxy for private issue screenshots stored in R2. Any signed-in
// user may view them (issues are company-wide). Mirrors the chat-media proxy:
// verify the requester, then 302-redirect to a short-lived signed URL served by
// the rf-media Worker.
