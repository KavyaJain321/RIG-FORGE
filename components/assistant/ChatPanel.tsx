...
export default function ChatPanel() {
  ...
  const content = (
    ...
    <div className="lg:hidden">
      ...
      {/* Panel — bg-surface-raised instead of pure white so the panel reads as
      ...
      <div
        className="fixed right-0 top-0 bottom-0 z-50 w-full sm:w-[440px] bg-surface-raised shadow-2xl flex flex-col panel-slide-in"
        role="dialog"
