...
export default function MemberRow({ projectId: _projectId, member, isAdmin, onRemoveMember }: Omit<MemberRowProps, 'onUpdateContribution'> & { onUpdateContribution?: (userId: string, contribution: number) => void }) {
